    ...
    <div class="container is-max-desktop ">
        <div class="column ">
            ...
            <div v-for="hitem in hothit" class="columns is-half ">
                <div class="column is-two-fifths px-6 is-vertical">
                    <div class="card-image ">
                        <p>
                            <b class="is-size-3 ">{{ hitem.hbrand }}</b>
                        </p><br><br>
                        <figure class="image is-3by3 ">
                            <img src="https://media.discordapp.net/attachments/1072181252964233328/1077261540748701726/home_car.png "
                ...
                <div class="column ">
                    <div class="is-multiline is-variable columns is-1 " >
                        ...
                        v-for="item in cars"
                        v-show="item.id == hitem.hid.find(g => g == item.id)"
                         >  
                            <div class="card has-text-centered is-border-radius ">
                                ...
                                <div class="card-content ">
                                    ...
                                    <p class="subtitle is-size-7 "> <img
                                ...
                                <footer class="card-footer ">
                                    <a href="#" rel="nofollow" @click="search()"
            ...
            <div class="column pl-6">
                <div class="column ">
                    <P>
                        <b class="is-size-3 ">Other</b>
                    </p><br>
                    <div class="is-multiline is-variable columns is-1 pl-6 ">
                        <div v-for="item in cars " id="card_product " class="column is-one-quarter "
                            v-show="item.id >= 15"
                        >
                            <div class="card has-text-centered is-border-radius ">
                                <div class="card-image">
                                ...
                                <footer class="card-footer ">
                                    <a href="#" rel="nofollow" @click="search()" class="card-footer-item is-color-green3 is-size-6 is-color-green3 has-text-white ">จองคันนี้</a>
                                </footer>
                            </div>
                        </div>
                    </div>
