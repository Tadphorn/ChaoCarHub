    ...
    <div class="column">
        <div class="hero-body ">
            <div class="card  p-5 has-background-primary-light ">
                ...
                <button @click="search()" class="button color-card-search has-text-white font " style="width: 100%; " type="submit ">
                  ค้นหารถว่าง                  
                </button>
            </div>
        </div>
...
<script >
// import {useCardemoStore} from "@/stores/Cardemo";
// const carStore = useCardemoStore();
export default {
  data: () => ({
    cars: [
      {
